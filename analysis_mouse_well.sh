...
MOUSE_IDS=(97 65 67 164 166 103 168 203 271 273 274 275 276 49 56 58 59 159)  # replace with your actual mouse IDs
...
for MOUSE_ID in "${MOUSE_IDS[@]}"; do
    ...
    python energy_over_time_script/main-wells.py --wells_file "$WELLS_FILE" --mouse_id "$MOUSE_ID"
